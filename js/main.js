"use strict";
const model_default = JeelizThreeGlassesCreator({
...
function init_threeScene(spec, model) {
...
function main(model) {
  JeelizResizer.size_canvas({
    ...
    callback: function (isError, bestVideoSettings) {
      init_faceFilter(bestVideoSettings, model);
    },
  });
}

function init_faceFilter(videoSettings, model) {
...
function change(n) {
  ...
  switch (n) {
    case 1:
      main(JeelizThreeGlassesCreator({
        envMapURL: "./envMap.jpg",
        frameMeshURL: "./models3D/glassesFramesBranchesBent.json",
        lensesMeshURL: "./models3D/glassesLenses.json",
        occluderURL: "./models3D/face.json"
    ...
    case 2:
      main(
        JeelizThreeGlassesCreator({
          envMapURL: "./envMap.jpg",
          frameMeshURL: "./models3D/glasses3Textured.json",
          lensesMeshURL: "./models3D/glassesLenses.json",
          occluderURL: "./models3D/face.json",
        })
      );
